...
@EnableMethodSecurity // Enables method-level security annotations like @PreAuthorize, @PostAuthorize, etc.
@Configuration
@EnableWebSecurity
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(request -> request
            ...
            .requestMatchers("/validacao").hasRole("ADMIN") // permite acesso apenas a admin
